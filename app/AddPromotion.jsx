...
const AddPromotion = (props) => {
  ...
  return (
    <div className="  " id="hide-scrollbar">
      <form method="dialog">
        <button className="absolute text-[2.5rem] right-4 top-3">✕</button>
      </form>
        ...
        <section className="flex flex-col gap-2">
          <section className=" flex mt-8 gap-10">
            ...
            <section className="flex w-full flex-col gap-2 ">
              <label htmlFor="seller" className="font-semibold text-2xl">
                Percentage
              </label>
              <select
                id="percentage"
          ...
          <section className="flex  gap-10 mt-5">
            <section className="w-full mt-[0.5rm] gap-10 ">
              <label className="w-[15rem] text-2xl font-semibold" htmlFor="">
                Start date
              </label>
