  ...
  return (
    <div>
      <div
        ...
        onClick={() =>
          document.getElementById("my_modal_Promotion").showModal()
        }
      >
        <div className="flex flex-col p-5 gap-5 bg-white rounded-b-2xl">
          <div className="font-semibold text-[1.6rem] ">{data?.promotiontitle}</div>
          <div>
      ...
      <section>
        <dialog id="my_modal_Promotion" className="modal">
              ...
              <section className="w-[65%] flex flex-col gap-6">
                  ...
                  <section className="bg-white flex-shrink-0 shadow-md h-72  w-60  p-4 rounded-xl ">
                    <div className="flex flex-col gap-4">
                      <Image
                        ...
                        src={
                          "https://images.unsplash.com/photo-1627243939602-6456a5ab231c?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTV8fHJvbmFsZG98ZW58MHx8MHx8fDA%3D"
                        }
                        width={1000}
                        height={1000}
                        alt="shopName"
                ...
                <section className="flex justify-between ">
                  ...
                  <div className="flex gap-2">
                    ...
                    <p>{moment(data?.endDate).format("MM DD YYYY")}</p>
                  </div>
                </section>
              </section>
            </section>
