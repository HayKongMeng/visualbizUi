  ...
  return (
    <div>
      <section>
        <Button
          onClick={() =>
            document.getElementById("my_modal_AddPromtion").showModal()
          }
        ...
        <section>
          <dialog id="my_modal_AddPromtion" className="modal">
            <div
              className="modal-box p-16 py-14 max-w-[70rem]  "
              id="hide-scrollbar"
            >
              <form method="dialog">
                <button className="absolute text-[2.5rem] right-4 top-3">
                  ✕
                </button>
              </form>
                  ...
                  <section className=" flex mt-8 gap-10">
                    <div className="w-full flex flex-col gap-2 ">
                      ...
                      <input
                        ...
                        name="title"
                        id="title"
                        className="border p-4 text-xl border-gray-200 w-full  rounded-2xl"
                    ...
                    <section className="flex w-full flex-col  gap-2">
                      ...
                      <select
                        id="percentage"
                        name="percentage"
                        className="border text-xl rounded-2xl border-gray-300  w-full p-4 "
                      >
