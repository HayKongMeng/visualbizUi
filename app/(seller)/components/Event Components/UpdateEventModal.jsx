...
const UpdateEventModal = ({ eventId }) => {
  ...
  const handleUpdateEvent = async (updateEvent) => {
    ...
    document.getElementById(`update_event_seller${eventId}`).close();
  };
  ...
  return (
    <div>
      <div
        onClick={() =>
          document.getElementById(`update_event_seller${eventId}`).showModal()
        }
        className="text-[1.2rem] py-3 cursor-pointer"
      >
        Update Event
      </div>
      <dialog id={`update_event_seller${eventId}`} className="modal">
            ...
            >
              ...
              <div className="flex justify-end mt-14 gap-8">
                <Button
                  ...
                  onClick={() =>
                    document
                      .getElementById(`update_event_seller${eventId}`)
                      .close()
                  }
